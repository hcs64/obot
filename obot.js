...
(function() {
  ...
  addCommandButtonAction = function(level) {
    if (level.mode === levelMode.STOPPED || level.mode === levelMode.LIVE_EDIT) {
  ...
  resetAndRunLevel = function() {
    this.bot.xi = this.initial_bot_location.xi;
    this.bot.yi = this.initial_bot_location.yi;
    this.bot.dir = this.initial_bot_location.dir;
    this.current_command = 0;
    this.mode = levelMode.PLAYING;
    this.last_t = Date.now() / 1000;
    return this.animation_mode = levelAnimMode.READY;
  };
  ...
  animateLevel = function(t) {
    ...
    switch (this.animation_mode) {
      case levelAnimMode.READY:
        ...
        if (!this.step()) {
          this.animation_mode = levelAnimMode.DONE;
          this.mode = levelMode.STOPPED;
        } else {
          this.animation_mode = levelAnimMode.MOVING;
        }
        break;
      case levelAnimMode.MOVING:
  ...
  stepLevelSimulation = function() {
    console.log("step, @current_command=" + this.current_command);
  ...
  setupControlPanel = function() {
    return {
      buttons: [play_button, go_up_button, go_down_button, go_left_button, go_right_button],
